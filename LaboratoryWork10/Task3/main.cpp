...
int main() {
    ...
    // Ввод коэффициентов квадратичной функции
    ...
    // Ввод начального и конечного значений x, а также шага
    ...
    // Создание потока для вычислений и записи данных в файл
    std::thread t1(calculate_and_write, a, b, c, x_start, x_end, x_step, "function_data.txt", std::ref(mtx));
